 ...
 * @coversDefaultClass \core_group\hook\group_created_post
 */
class group_created_post_test extends \advanced_testcase {
    ...
    public function test_get_hook_description(): void {
        $this->assertIsString(
            actual: group_created_post::get_hook_description(),
        );
    }
    ...
    public function test_hook_tags(): void {
        $this->assertIsArray(
            actual: group_created_post::get_hook_tags(),
        );
        $this->assertSame(
            expected: ['group'],
            actual: group_created_post::get_hook_tags(),
    ...
    public function test_hook_dispatch(): void {
        ...
        $count = 0;
        $receivedhook = null;
        $testcallback = function(group_created_post $hook) use (&$receivedhook, &$count): void {
            $count++;
            $receivedhook = $hook;
        };

        $this->redirectHook(
            hookname: group_created_post::class,
        ...
        $this->assertInstanceOf(
            expected: group_created_post::class,
            actual:$receivedhook,
        );
        $this->assertSame(
            expected: $group1->id,
