...
class api_test extends \advanced_testcase {
    ...
    /**
     * Test delete_room_members to remove members for the room.
     *
     * @covers ::delete_room_members
     */
    public function test_delete_room_members(): void {
        $this->resetAfterTest();
        $course = $this->get_course();
        ...
        $communication->delete_room_members();
