...
class communication_room_operations extends adhoc_task {
    ...
    public function execute() {
        ...
        $communication = new communication($this->get_custom_data()->provider, $this->get_custom_data()->commid);
        $communication->set_room_options($this->get_custom_data()->roomname,
            $this->get_custom_data()->roomdesc, new \moodle_url($this->get_custom_data()->avatarurl));
