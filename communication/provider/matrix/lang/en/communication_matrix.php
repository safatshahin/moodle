...
$string['matrixaccesstokenuser'] = 'Matrix token user';
$string['matrixaccesstokenuser_desc'] = 'Matrix user ID associated to the Matrix access token (e.g. @matrixuser:synapse). This user will always have the maximum power level in created rooms.';
