...
class matrix_form_definition_test extends \advanced_testcase {
    ...
    /**
     * Test get form data options.
     *
     * @return void
     * @covers ::get_form_data_options
     */
    public function test_get_form_data_options(): void {
        $expectedresukt = ['matrixroomtopic'];
        $matrixformoptions = matrix_form_definition::get_form_data_options();
        $this->assertEquals($expectedresukt, $matrixformoptions);
    }
    ...
    public function test_set_form_data(): void {
        ...
        foreach ($matrixformoptions as $matrixformoption) {
            $this->assertNotNull($course->$matrixformoption);
        }
    }
