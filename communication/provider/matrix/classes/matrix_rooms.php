...
class matrix_rooms {
     ...
     * @return bool
     */
    public function is_room_data_available(): bool {
        return !empty($this->roomid) && !empty($this->roomalias);
    }
     ...
     * @return string|null
     */
    public function get_room_alias(): ?string {
     ...
     *
     * @param int $commid ID of the communication object
     * @return void
     */
    public function set_communication_id(int $commid): void {
        $this->commid = $commid;
    }
     ...
     * Set room id.
     *
     * @param string $roomid The id of the room to set
     * @return void
     */
    public function set_roomid(string $roomid): void {
        $this->roomid = $roomid;
    }
     ...
     * Set room alias.
     *
     * @param string $roomalias The alias of te room to set
     * @return void
     */
    public function set_room_alias(string $roomalias): void {
