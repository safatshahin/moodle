...
$string['hook_enrol_instance_deleted_pre'] = 'Hook dispatched after an enrolment instance is deleted.';
$string['hook_enrol_instance_status_updated_post'] = 'Hook dispatched after an enrolment instance status is changed.';
$string['hook_user_enrolled_post'] = 'Hook dispatched after a user is enrolled in a course.';
$string['hook_user_enrolment_updated_pre'] = 'Hook dispatched before a user enrolment is updated.';
$string['hook_user_unenrolled_pre'] = 'Hook dispatched before a user is enrolment is removed from a course.';
