...
$string['configure_sms_gateways'] = 'Configure SMS gateway';
$string['countrycode'] = 'Country code';
$string['countrycode_help'] = 'Set the default phone number format to exclude the "+" symbol if user do not enter an international number with it.';
...
$string['sms_gateway_delete_failed'] = 'Cannot delete {$a->gateway} SMS gateway, this gateway might be in use or database issue found, please check the usage or contact your database administrator.';
$string['sms_gateway_disable_failed'] = 'Cannot disable the SMS gateway, this gateway might be in use or database issue found, please check the usage or contact your database administrator.';
