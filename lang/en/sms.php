...
$string['sms_gateway_delete_failed'] = 'Cannot delete {$a->gateway} SMS gateway. The gateway is either in use or there\'s database issue. Please contact your database administrator for help.';
$string['sms_gateway_disable_failed'] = 'Cannot disable the SMS gateway. The gateway is either in use or there\'s database issue. Please contact your database administrator for help.';
