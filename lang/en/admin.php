...
$string['guzzleignoresecurityhosts'] = 'Guzzle ignore security hosts';
$string['guzzleignoresecurityhostssyntax'] = 'Hosts to ignore any security settings to allow usage in development, testing etc. Put one entry each line.';
