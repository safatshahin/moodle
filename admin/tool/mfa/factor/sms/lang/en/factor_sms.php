...
$string['notification:smsgatewaymigration'] = 'SMS settings migration';
$string['notification:smsgatewaymigrationinfo'] = 'A new SMS subsystem is in place and the existing SMS related configuration is migrated over to the new gateway instance.
To make changes to your existing SMS configuration, you will need to <a href="{$a}">use this page</a>.';
...
$string['settings:heading'] = 'Users will receive an SMS with 6-digit code during login, which they must enter to complete the login process. Users will need to register their mobile phone number first.

To use SMS as an authentication factor, you first need to <a href="{$a}">set up an SMS gateway</a>.';
