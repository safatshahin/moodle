...
You will need to <a href="{$a}">set up an SMS gateway</a> to use the SMS factor.';
$string['settings:headingnotification'] = 'You will need to <a href="{$a}">set up an SMS gateway</a> to use the SMS factor.';
