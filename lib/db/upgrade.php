...
privatefiles,moodle|/user/files.php';
    ...
    if ($oldversion < 2023021000.00) {
        ...
        $table->add_field('status', XMLDB_TYPE_INTEGER, '1', null, XMLDB_NOTNULL, null, null, 'id');
        $table->add_field('instanceid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null, 'status');
        $table->add_field('component', XMLDB_TYPE_CHAR, '100', null, XMLDB_NOTNULL, null, null, 'instanceid');
        $table->add_field('provider', XMLDB_TYPE_CHAR, '100', null, XMLDB_NOTNULL, null, null, 'component');
        $table->add_field('roomname', XMLDB_TYPE_CHAR, '255', null, null, null, null, 'provider');
        $table->add_field('roomdesc', XMLDB_TYPE_CHAR, '255', null, null, null, null, 'roomname');
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2023021000.00);
    }
