...
/**
 * Hook before an user enrolment is updated.
 *
 * @package    core
 * @copyright  2023 Safat Shahin <safat.shahin@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_enrolment_updated_pre implements \core\hook\described_hook {
    ...
    public static function get_hook_description(): string {
        return 'Hook dispatched before an user enrolment is updated.';
    }
