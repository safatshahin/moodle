...
function update_course($data, $editoroptions = NULL) {
    ...
    $communication = new \core_communication\communication_handler($data);
    // TODO MDL-76708 add the logic to remove all users from the room if the course hidden.
    // We don't need to update room when a course is hidden, only remove users from it.
