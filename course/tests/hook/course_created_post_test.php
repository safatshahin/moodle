 ...
 * @coversDefaultClass \core_course\hook\course_created_post
 */
class course_created_post_test extends \advanced_testcase {
    ...
    public function test_get_hook_description(): void {
        $this->assertIsString(
            actual: course_created_post::get_hook_description(),
        );
    }
    ...
    public function test_hook_tags(): void {
        $this->assertIsArray(
            actual: course_created_post::get_hook_tags(),
        );
        $this->assertSame(
            expected: ['course'],
            actual: course_created_post::get_hook_tags(),
    ...
    public function test_hook_dispatch(): void {
        ...
        $count = 0;
        $receivedhook = null;
        $testcallback = function(course_created_post $hook) use (&$receivedhook, &$count): void {
            $count++;
            $receivedhook = $hook;
        };

        $this->redirectHook(
            hookname: course_created_post::class,
        ...
        $this->assertInstanceOf(
            expected: course_created_post::class,
            actual:$receivedhook,
        );
        $this->assertSame(
            expected: $course1->id,
