...
Feature: Access the SMS gateways page
  As an admin
  Manage different gateway configurations from this page
  ...
  Scenario: An admin can manage the SMS gateways in the gateway management page
    ...
    And I should see "Enable" in the "Default" "table_row"
    And I should see "Enable" in the "Europe" "table_row"
    When I click on "Enable" "checkbox" in the "Default" "table_row"
    Then I should see "Disable" in the "Default" "table_row"
    ...
    And I should see "Are you sure you want to delete the SMS gateway?"
