...
$string['aws_key'] = 'Key';
$string['aws_key_help'] = 'Amazon API key credential.';
$string['aws_region'] = 'Region';
$string['aws_region_help'] = 'Amazon API gateway region.';
$string['aws_secret'] = 'Secret';
$string['aws_secret_help'] = 'Amazon API secret credential.';
$string['aws_usecredchain'] = 'Find AWS credentials using the default credential provider chain';
