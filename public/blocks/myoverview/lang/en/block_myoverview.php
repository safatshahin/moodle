...
$string['allhidden_intro'] = 'To see or restore them, select "Removed from view" in the filter menu.';
$string['allhidden_title'] = 'All your courses are removed from view';
$string['allincludinghidden'] = 'All (including removed from view)';
$string['aria:addtofavouritesfor'] = 'Star for {$a}';
$string['aria:courseactions'] = 'Actions for course';
$string['aria:courseactionsfor'] = 'Actions for course {$a}';
$string['aria:courseremoved'] = 'Course removed from view.';
$string['aria:courserestored'] = 'Course restored to view.';
$string['aria:displaydropdown'] = 'Display drop-down menu';
$string['aria:groupingdropdown'] = 'Grouping drop-down menu';
$string['aria:removefromfavouritesfor'] = 'Remove star for {$a}';
...
$string['errorloadingcourses'] = 'An error occurred while loading your courses. Please try again.';
...
$string['noresults_intro'] = 'Try different keywords or clear your filters to see all courses.';
$string['noresults_title'] = 'No courses match your search';
$string['past'] = 'Past';
$string['pluginname'] = 'Course overview';
$string['privacy:metadata:overviewgroupingcustomfieldvaluepreference'] = 'The custom field value the Course overview block is grouped by.';
$string['privacy:metadata:overviewgroupingpreference'] = 'The Course overview block grouping preference.';
$string['privacy:metadata:overviewhiddencoursepreference'] = 'Whether the user has removed a course from view in the Course overview block.';
...
$string['zero_request_intro_short'] = 'You don\'t have any courses yet. Request one to get started, it\'ll appear here once it\'s set up.';
