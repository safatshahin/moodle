...
Feature: The my overview block allows users to hide their courses
  ...
  Scenario: A user who has removed every course from view can still reach the filter to restore them
    ...
    And I click on ".courseoverview-iconbtn" "css_element" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' courseoverview-card ') and contains(.,'Course 2')]" "xpath_element"
    And I click on "Remove from view" "button" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' courseoverview-card ') and contains(.,'Course 2')]" "xpath_element"
    And I click on ".courseoverview-iconbtn" "css_element" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' courseoverview-card ') and contains(.,'Course 3')]" "xpath_element"
    ...
    And I click on ".courseoverview-iconbtn" "css_element" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' courseoverview-card ') and contains(.,'Course 4')]" "xpath_element"
