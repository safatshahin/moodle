...
Feature: Resize the course index drawer
  ...
  @javascript
  Scenario: Resize the course index with the keyboard and have the width remembered
    ...
    Then the "aria-valuenow" attribute of ".drawerresizehandle" "css_element" should contain "640"
