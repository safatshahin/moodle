...
$string['quizhaspendingbestattemptcalculation'] = 'The best attempt for each user is still being calculated for this quiz. Until this completes, best attempts will not be highlighted and the option to show only the best attempt per user will not work.';
