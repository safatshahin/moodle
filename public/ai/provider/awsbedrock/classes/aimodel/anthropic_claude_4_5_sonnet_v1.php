 ...
 */
class anthropic_claude_4_5_sonnet_v1 extends anthropic_claude_3_5_sonnet_v1 implements awsbedrock_base {
    #[\Override]
        ...
        return array_merge($settings, [
            ...
            'cross_region_inference' => [
                ...
                'help' => [
                    'identifier' => 'settings_cross_region_inference',
                    'component' => 'aiprovider_awsbedrock',
                    'a' => ['default' => 'global.anthropic.claude-sonnet-4-5-20250929-v1:0'],
                ],
            ],
        ]);
    }
