...
/**
 * Claude 4.0 Sonnet AI model.
 *
 * @package    aiprovider_awsbedrock
 * @copyright  2026 Raquel Ortega <raquel.ortega@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class anthropic_claude_4_0_sonnet_v1 extends anthropic_claude_3_5_sonnet_v1 implements awsbedrock_base {
    #[\Override]
        ...
        return array_merge($settings, [
            ...
            'cross_region_inference' => [
                ...
                'help' => [
                    'identifier' => 'settings_cross_region_inference',
                    'component' => 'aiprovider_awsbedrock',
                    'a' => ['default' => 'global.anthropic.claude-sonnet-4-20250514-v1:0'],
                ],
            ],
        ]);
    }
