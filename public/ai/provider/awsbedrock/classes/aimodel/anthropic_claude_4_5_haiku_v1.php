...
/**
 * Class Claude 4.5 Haiku AI model.
 *
 * @package    aiprovider_awsbedrock
 * @copyright  2026 Raquel Ortega <raquel.ortega@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class anthropic_claude_4_5_haiku_v1 extends anthropic_claude_3_5_sonnet_v1 implements awsbedrock_base {
    #[\Override]
    ...
    public function get_model_settings(): array {
        ...
        if (isset($settings['max_tokens']['help']['a']['max'])) {
            $settings['max_tokens']['help']['a']['max'] = 65536;
        }
        return array_merge($settings, [
            ...
            'cross_region_inference' => [
                ...
                'help' => [
                    'identifier' => 'settings_cross_region_inference',
                    'component' => 'aiprovider_awsbedrock',
                    'a' => ['default' => 'global.anthropic.claude-haiku-4-5-20251001-v1:0'],
                ],
            ],
        ]);
    }
