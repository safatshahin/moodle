        ...
        return [
            ...
            'topK' => [
                ...
                'help' => [
                    'identifier' => 'settings_top_k',
                    'component' => 'aiprovider_awsbedrock',
                    'a' => ['min' => 0, 'max' => 128, 'default' => get_string('none', 'aiprovider_awsbedrock')],
                ],
            ],
            ...
            'maxTokens' => [
                ...
                'help' => [
                    'identifier' => 'settings_max_tokens',
                    'component' => 'aiprovider_awsbedrock',
                    'a' => ['min' => 0, 'max' => 5000, 'default' => get_string('none', 'aiprovider_awsbedrock')],
                ],
            ],
            ...
            'schemaVersion' => [
                'elementtype' => 'text',
                'label' => [
                    'identifier' => 'settings_schema_version',
                    'component' => 'aiprovider_awsbedrock',
                ],
                'type' => PARAM_TEXT,
                'help' => [
