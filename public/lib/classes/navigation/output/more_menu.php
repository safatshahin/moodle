...
class more_menu implements renderable, templatable {
    ...
    /**
     * Build the JSON props consumed by the core/nav/SecondaryNav component.
     *
    ...
    /**
     * Recursively flatten a navigation node into a JSON-safe array for the SecondaryNav component.
     *
    ...
    /**
     * Resolve the href a node should navigate to when rendered by the SecondaryNav component.
     *
