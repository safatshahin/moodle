...
final class more_menu_test extends advanced_testcase {
     ...
     * SecondaryNav component, propagating the istablist flag passed to the more_menu constructor.
     *
     * @return void
     */
     ...
     * and component_actions (e.g. popup_action), which the React SecondaryNav component needs to
