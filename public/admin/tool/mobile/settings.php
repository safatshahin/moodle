...
if ($hassiteconfig || has_capability('moodle/site:configview', context_system::instance())) {
    ...
    $ispremiumplan = tool_mobile_is_premium_or_bma_plan($subscriptiondata, false);
    ...
    if ($hassiteconfig && !during_initial_install() && !$ispremiumplan) {
        ...
        if (tool_mobile_has_matomo_additional_html() && ($additionalhtmlpage = $ADMIN->locate('additionalhtml'))) {
