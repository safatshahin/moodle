...
function tool_installaddon_custom_chooser_footer(int $courseid, int $sectionid): activity_chooser_footer {
    ...
    // TODO: Update this according to the actual logo used in the Marketplace.
    // We might even import the logo as a plugin asset if it is not available on the Marketplace site.
    $marketplacelogo = 'https://marketplace.moodle.com/assets/icons/MarketPlaceLogoTm-78753bf249261f16c97c4db0325a1d3d.svg';
