...
$string['marketplacefooterlink'] = 'Or browse plugins in Marketplace';
$string['marketplacefooterlinkaria'] = 'Browse plugins in Moodle Marketplace';
$string['marketplaceintegrationnotice'] = 'Moodle Marketplace integration is now available. Browse plugins in <a href="{$a}" target="_blank" rel="noopener noreferrer">Moodle Marketplace</a>.';
